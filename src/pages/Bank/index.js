        ...
        const rightMap = {
            '存款': (
                <div style={{ width: 200, marginTop: 150 }}>
                    ...
                    <Button type="primary" style={{ width: '100%', margin: '10px 0' }} disabled={saveMoney === ''} onClick={this.handleOper.bind(this, 1)}>存款</Button>
                </div>
            ),
            '取款': (
                <div style={{ width: 200, marginTop: 150 }}>
                    取款金额:<Input value={fetchMoney} onChange={(e) => this.setState({ fetchMoney: e.target.value })} type="number"></Input>
                    <Button type="primary" style={{ width: '100%', margin: '10px 0' }} disabled={fetchMoney === ''} onClick={this.handleOper.bind(this, 2)}>取款</Button>
                </div>
            ),
            '转账': (
                <div style={{ width: 200, marginTop: 150 }}>
                    ...
                    <Button type="primary" style={{ width: '100%', margin: '10px 0' }} disabled={transName === '' || transMoney === ''} onClick={this.handleOper.bind(this, 3)}>转账</Button>
                </div>
            ),
            '交易记录': (
                <Table style={{ width: '100%' }} dataSource={record} columns={columns} pagination={false} scroll={{ y: '60vh' }}></Table>
            )
        }
        return (
            <div>
